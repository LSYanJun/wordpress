<?php
    ...
    function one_paze_additional_customize_register( $wp_customize ) {
         ...
         * Settings
         */
        /** One Paze Other Settings **/
        //foreach($one_paze_other_settings as $one_paze_other_setting) :
//            $wp_customize->add_setting($one_paze_other_setting['id'],$one_paze_other_setting['args']);
//        endforeach;
        ...
        foreach($one_paze_other_controls as $one_paze_other_control) :
            ...
            $misc = isset($one_paze_other_control['misc']) ? $one_paze_other_control['misc'] : false;
            switch($misc) :
                case 'image' :
                    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,$one_paze_other_control['id'],$one_paze_other_control['args']));
                    break;
                default :
                    $wp_customize->add_control($one_paze_other_control['id'], $one_paze_other_control['args']);
            endswitch; */
