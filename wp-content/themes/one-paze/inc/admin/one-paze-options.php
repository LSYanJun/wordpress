<?php
    ...
    $one_paze_sections = array(
        ...
        /*
        'footer' => array(
            'id' => '<strong>footer_section</strong>',
            'args' => array(
                'title' => __('Footer Settings', 'one-paze'),
                'description' => __('Footer Section Configurations', 'one-paze'),
                'priority' => 900,
                'capability' => 'edit_theme_options',
            )
        ),
...
/*
    $wp_customize->add_setting(
        'services_disable_feat_img',
        array(
            'default' => 0,
            'sanitize_callback' => 'one_paze_sanitize_page_checkbox',
        )
    );
*/    
    ...
    */ 
    ...
    /*$wp_customize->add_setting(
        ...
        array(
            'default' => '',
            'sanitize_callback' => 'one_paze_sanitize_iframe_code',
        )
    );*/
    ...
    $one_paze_other_controls = array(         
        ...
        /*'contact_section_gmap_iframe' => array(
            'id' => 'contact_section_gmap_iframe',
            'args' => array(
                'label' => __('Google Map Iframe Code', 'one-paze'),
                'section' => 'contact_section',
                'type' => 'textarea',
                'priority' => 10
            )
     ...
     */
        ...
        **/
            ...
            $wp_customize->add_section(
                'our_product_info',
                array(
                  'title'           =>  __('Our Products', 'one-paze'),
                  'priority'        =>  '2',
                  'panel' => 'theme_info', )
                );    
            ...
            $our_product = '<a target="_blank" href="'.admin_url().'themes.php?page=accesspressstore-themes">'.__('More Free Themes','one-paze').'</a> <br />';
        
            $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'theme_info_more_theme',array(
                'label' => __( 'More Free Themes' , 'one-paze' ),
            ...
            $our_product = '<a target="_blank" href="https://accesspressthemes.com/wordpress-themes/">'.__('AccessPress PRO Themes','one-paze').'</a> <br />';
        
            $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'theme_info_pro_theme',array(
                'label' => __( 'AccessPress PRO Themes' , 'one-paze' ),
                'section' => 'our_product_info',
                'description' => $our_product
                )));
            ...
            $our_product = '<a target="_blank" href="'.esc_url('https://accesspressthemes.com/plugins/').'">'.__('AccessPress Plugins','one-paze').'</a>';  
        
            $wp_customize->add_control( new Theme_Info_Product_Custom_Control( $wp_customize ,'theme_info_useful_plugins',array(
                'label' => __( 'AccessPress Plugins' , 'one-paze' ),
                'section' => 'our_product_info',
                'description' => $our_product
                )));        
